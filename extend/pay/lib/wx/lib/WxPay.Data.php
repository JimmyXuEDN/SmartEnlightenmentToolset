 ...
 *
 */
class WxGetPublicKey extends WxPayDataBase
{
    /**
     * 设置微信支付分配的商户号
     * @param string $value
 ...
 *
 */
class WxTransferBank extends WxPayDataBase
{
    /**
     * 设置微信支付分配的商户号
     * @param string $value
     ...
     * @param string $value
     **/
    public function SetBank_no($value)
    {
     ...
     * @param string $value
     **/
    public function SetTrue_name($value)
    {
     ...
     * @return true 或 false
     **/
    public function IsTrue_nameSet()
    {
 ...
 *
 */
class WxTransferPurse extends WxPayDataBase
{
    /**
     * 设置微信支付分配的商户号
     * @param string $value
