...
class SDKConfig {
	...
	public $zhrzFrontTransUrl;
	public $zhrzBackTransUrl;
	public $zhrzSingleQueryUrl;
	public $zhrzBatchTransUrl;
	public $zhrzAppTransUrl;
	public $zhrzFaceTransUrl;
	...
	function __construct(){
		...
		$configFilePath = EXTEND_PATH ."pay".DS."lib".DS."union".DS."ini".DS."acp_prod_sdk.ini";
		//$configFilePath = EXTEND_PATH ."pay".DS."lib".DS."union".DS."ini".DS."acp_test_sdk.ini";
